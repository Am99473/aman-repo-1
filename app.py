...
with open('NewYork_taxi_price_prediction_model.pickle','rb') as f:
    model = pickle.load(f)
...
# Always specify the data type while creating array from numpy else it will give error in deployment.
